...
public class KesiapanAdapter extends RecyclerView.Adapter<KesiapanAdapter.ViewHolder> implements Filterable {
    private ArrayList<PinjamRuang> mArrayList;
    private ArrayList<PinjamRuang> mFilteredList;

    public KesiapanAdapter(ArrayList<PinjamRuang> arrayList){
        mArrayList = arrayList;
        mFilteredList = arrayList;
    }

    @Override
    public KesiapanAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
    ...
    @Override
    public void onBindViewHolder(KesiapanAdapter.ViewHolder holder, int i) {
