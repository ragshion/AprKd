...
public class MobilAdapter extends RecyclerView.Adapter<MobilAdapter.ViewHolder> implements Filterable {
    private ArrayList<Mobil> mArrayList;
    private ArrayList<Mobil> mFilteredList;

    public MobilAdapter(ArrayList<Mobil> arrayList){
        mArrayList = arrayList;
        mFilteredList = arrayList;
    }

    @Override
    public MobilAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
    ...
    @Override
    public void onBindViewHolder(MobilAdapter.ViewHolder holder, int i) {
        holder.tv_ruang.setText(mFilteredList.get(i).getNopol());
        holder.tv_fasilitas.setText(mFilteredList.get(i).getMerk());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Mobil> filteredList = new ArrayList<>();

                    for (Mobil ruang : mArrayList) {

                        if (ruang.getNopol().toLowerCase().contains(charString) || ruang.getMerk().toLowerCase().contains(charString)) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mFilteredList = (ArrayList<Mobil>) filterResults.values;
