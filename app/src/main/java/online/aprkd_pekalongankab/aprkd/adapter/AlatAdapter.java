...
public class AlatAdapter extends RecyclerView.Adapter<AlatAdapter.ViewHolder> implements Filterable {
    private ArrayList<Alat> mArrayList;
    private ArrayList<Alat> mFilteredList;

    public AlatAdapter(ArrayList<Alat> arrayList){
        mArrayList = arrayList;
        mFilteredList = arrayList;
    }

    @Override
    public AlatAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
    ...
    @Override
    public void onBindViewHolder(AlatAdapter.ViewHolder holder, int i) {
        ...
        holder.tv_no_surat.setText(mFilteredList.get(i).getNamaPerlengkapan());
        holder.tv_peminjam.setText(mFilteredList.get(i).getJumlah());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Alat> filteredList = new ArrayList<>();

                    for (Alat pinjamRuang : mArrayList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mFilteredList = (ArrayList<Alat>) filterResults.values;
