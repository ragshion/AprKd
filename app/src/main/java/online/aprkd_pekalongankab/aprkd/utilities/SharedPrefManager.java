package online.aprkd_pekalongankab.aprkd.utilities;
...
public class SharedPrefManager {
    ...
    public static final String SP_ID_PENANGGUNGJAWAB = "spIDPenanggungjawab";
    ...
    public static final String SP_BIDANG = "spBidang";
    public static final String SP_TOPIC = "spTopik";
    public static final String SP_TOPIC2 = "spTopik2";
    ...
    public String getSpIdPenanggungjawab(){
        return sp.getString(SP_ID_PENANGGUNGJAWAB, "");
    }
    public String getSpJenis(){
        return sp.getString(SP_JENIS, "");
    }
    public String getSpTopic(){
        return sp.getString(SP_TOPIC, "");
    }
    public String getSpTopic2(){
        return sp.getString(SP_TOPIC2, "");
    }
    ...
    public String getSpBidang(){
        return sp.getString(SP_BIDANG, "");
    }
