        ...
        navigationDrawerLeft = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position){
                            case 2:
                                Intent ruang = new Intent(MainActivity.this, RuangActivity.class);
                                startActivity(ruang);
                                navigationDrawerLeft.setSelection(pinjamRuang);
                                break;
                            case 4:
                                Intent pinjamKnd = new Intent(MainActivity.this, PinjamKendaraanActivity.class);
                                pinjamKnd.putExtra("peminjaman","kendaraan");
                                startActivity(pinjamKnd);
                                finish();
                                break;
                            case 5:
                                Intent kendaraan = new Intent(MainActivity.this, KendaraanActivity.class);
                                startActivity(kendaraan);
                                navigationDrawerLeft.setSelection(pinjamRuang);
                                break;
                            case 7:
                                Intent pinjamAlt = new Intent(MainActivity.this, PinjamAlatActivity.class);
                                pinjamAlt.putExtra("peminjaman","alat");
                                startActivity(pinjamAlt);
                                finish();
                                break;
                            case 8:
                                Intent Alat = new Intent(MainActivity.this, AlatActivity.class);
                                startActivity(Alat);
                                navigationDrawerLeft.setSelection(pinjamRuang);
                                break;
                            case 10:
                                if(sharedPrefManager.getSPSudahLogin()){
                                    ...
                                    FirebaseMessaging.getInstance().unsubscribeFromTopic(sharedPrefManager.getSpIdPenanggungjawab());
                            ...
                            case 11:
                                Intent kesiapan = new Intent(MainActivity.this, KesiapanActivity.class);
