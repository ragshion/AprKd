...
public class PinjamKendaraanActivity extends AppCompatActivity {
    ...
    PrimaryDrawerItem pinjamKendaraan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pinjamKendaraan = new PrimaryDrawerItem()
                .withIdentifier(3)
        ...
        navigationDrawerLeft = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position){
                            case 1:
                                Intent pinjamRng = new Intent(PinjamKendaraanActivity.this, MainActivity.class);
                                pinjamRng.putExtra("peminjaman","ruang");
                                startActivity(pinjamRng);
                                finish();
                                break;
                            case 2:
                                Intent ruang = new Intent(PinjamKendaraanActivity.this, RuangActivity.class);
                                startActivity(ruang);
                                navigationDrawerLeft.setSelection(pinjamKendaraan);
                                break;
                            case 5:
                                Intent kendaraan = new Intent(PinjamKendaraanActivity.this, KendaraanActivity.class);
                                startActivity(kendaraan);
                                navigationDrawerLeft.setSelection(pinjamKendaraan);
                                break;
                            case 7:
                                Intent pinjamAlt = new Intent(PinjamKendaraanActivity.this, PinjamAlatActivity.class);
                                pinjamAlt.putExtra("peminjaman","alat");
                                startActivity(pinjamAlt);
                                finish();
                                break;
                            case 8:
                                Intent Alat = new Intent(PinjamKendaraanActivity.this, AlatActivity.class);
                                startActivity(Alat);
                                navigationDrawerLeft.setSelection(pinjamKendaraan);
                                break;
                            case 10:
                                if(sharedPrefManager.getSPSudahLogin()){
                                    ...
                                    startActivity(new Intent(PinjamKendaraanActivity.this, MainActivity.class)
                                            .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK));
                                    finish();
                                    break;
                                }else{
                                    Intent login = new Intent(PinjamKendaraanActivity.this, LoginActivity.class);
                                    startActivity(login);
                                    navigationDrawerLeft.setSelection(pinjamKendaraan);
                                    break;
                                }
                            case 11:
                                Intent kesiapan = new Intent(PinjamKendaraanActivity.this, KesiapanActivity.class);
