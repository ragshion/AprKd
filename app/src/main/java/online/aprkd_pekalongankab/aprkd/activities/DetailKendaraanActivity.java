...
public class DetailKendaraanActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent formEdit = new Intent(DetailKendaraanActivity.this,UpdateKesiapan.class);
        ...
        foto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DetailKendaraanActivity.this, DetailImage.class);
    ...
    void loadDetail(String id){
        ...
        serviceAPI.getDetailPeminjamanKendaraan(id).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try{
                    ...
                    tempat.setText(jsonRESULTS.getJSONObject("data").getString("tempat"));
                    tanggal.setText(jsonRESULTS.getJSONObject("data").getString("tanggal")+" - "+jsonRESULTS.getJSONObject("data").getString("tanggal_selesai"));
                    ...
                    if(jsonRESULTS.getJSONObject("data").getString("foto_kesiapan").equals("default")){
                        ...
                        Glide.with(DetailKendaraanActivity.this)
                                .load(thumbnail)
                                .thumbnail(Glide.with(DetailKendaraanActivity.this).load(R.drawable.def))
                                .fitCenter()
                                .crossFade()
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(DetailKendaraanActivity.this, error, Toast.LENGTH_SHORT).show();
            }
        });
    }
