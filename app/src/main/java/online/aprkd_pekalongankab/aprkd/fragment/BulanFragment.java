...
public class BulanFragment extends android.support.v4.app.Fragment {
...
//        recyclerView.setAdapter(adapter);
    ...
    private void loadJSON(){
        ...
        Call<JsonArray> loadBidang = serviceAPI.getPeminjamanRuang("bulan");
        loadBidang.enqueue(new Callback<JsonArray>() {
            @Override
    ...
    private void loadKendaraan(){
        ...
        Service serviceAPI = Client.getClient();
        Call<JsonArray> loadHari = serviceAPI.getPeminjamanKendaraan("bulan");
    ...
    private void loadAlat(){
        ...
        Service serviceAPI = Client.getClient();
        Call<JsonArray> loadHari = serviceAPI.getPeminjamanAlat("bulan");
        loadHari.enqueue(new Callback<JsonArray>() {
            @Override
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                String faskesString = response.body().toString();
