...
import online.aprkd_pekalongankab.aprkd.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int [] icon = {R.drawable.ic_camera_black_24dp, R.drawable.ic_chat_black_24dp,R.drawable.ic_explore_black_24dp};
    String [] judul = {"Camera","Chat"};
    String [] deskripsi = {"belajar camera","belajar chat"};
